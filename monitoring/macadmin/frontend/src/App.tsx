...
import { ProcessesPage } from './pages/system'
import { StoragePage } from './pages/system'
import { NetworkPage } from './pages/system'
import { UsersPage } from './pages/system'
import { SoftwareUpdatePage } from './pages/system'
import { LogsPage } from './pages/system'
import { FileBrowserPage } from './pages/system'
import { TerminalPage } from './pages/system'
